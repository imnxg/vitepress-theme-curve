  ...
  <div v-if="postMetaData" class="post">
    ...
    <div class="post-content">
      <article class="post-article s-card">
        ...
        <!-- 文章内容 -->
        <div 
          class="content markdown-body markdown-main-style" 
...
const postMetaData = computed(() => {
  ...
  // const postId = generateId("article/" + id);
  
  console.log('Looking for post with id:', id)
  console.log('theme.value.postData', theme.value.postData.find((item) => item.id === id))
  return theme.value.postData.find((item) => item.id === id);
});


const currentPost = computed(() => {
  if (!theme.value?.postData) {
